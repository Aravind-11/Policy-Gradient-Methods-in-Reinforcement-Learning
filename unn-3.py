...
def full_forward_propagation(X, u_params_values, nn_architecture):
    memory = {}
    A_curr = X
    ...
    for idx, layer in enumerate(nn_architecture):
        ...
        W_curr = u_params_values["W" + str(layer_idx)]
        b_curr = u_params_values["b" + str(layer_idx)]
...
def u_full_backward_propagation(Y_hat,a, v,memory, params_values, nn_architecture):
    grads_values = {}
    #m = Y.shape[1]
